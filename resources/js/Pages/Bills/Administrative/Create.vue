    ...
    <app-layout>
        ...
        <div class="lg:py-2">
            <div class="mx-auto sm:px-6 lg:px-8">
                ...
                <h2 class="py-3 px-1">{{ __("Add Administrative Bill") }}</h2>
                    ...
                    <div class="w-full">
                        <div class="w-full">
                            <div class="result my-5 w-full">
                                ...
                                <!-- medium screen -->
                                <table class="mx-auto hidden md:block md:w-full">
                                    <thead class="w-full text-center bg-gray-300">
                                        <th class="bg-[#f8f9fa] p-1 border border-[#eceeef] w-3/5">
                                            {{ __('Item') }}
                                            <button @click="addNewItemDialog()" class="cursor-pointer ml-4">
                                                <i class="fa-solid fa-plus"></i>
                                            </button>
                                        ...
                                        <!-- <th class="bg-[#f8f9fa] p-1 border border-[#eceeef]">{{ __('Quantity') }}</th> -->
                                        <th class="bg-[#f8f9fa] p-1 border border-[#eceeef] w-1/5">{{ __('Total Price') }}</th>
                                        <th class="bg-[#f8f9fa] p-1 border border-[#eceeef] w-1/5" >{{ __('Action') }}</th>
                                    </thead>
...
export default {
    ...
    methods: {
        ...
        onSave: function () {
            axios
                .post(route("bills.administrative.store"), this.form)
                .then((response) => {
    ...
    created: function created() {
        ...
        axios
            ...
            .then((response) => {
                ...
                this.items = tmp.filter((item) => item.storable == 0);
