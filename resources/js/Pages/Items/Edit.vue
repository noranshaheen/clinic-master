		...
		<template #content>
			...
			<form @submit.prevent="submit">
				<div class="grid grid-cols-2 gap-4">
					<div>
						<jet-label for="itemName" :value="__('Item Name')" />
					...
					<div>
						...
						<jet-input id="weight" type="number" class="mt-1 block w-full" 
						v-model="form.weight" required
							autofocus />

						<jet-label for="selling_price" :value="__('Selling Price per unit')" />
						<jet-input id="selling_price" type="number" class="mt-1 block w-full" 
