        ...
        <template #content>
            ...
            <form @submit.prevent="submit">
                <div class="grid grid-cols-2 gap-4">
                    <TextField class="col-span-2" v-model="form.code" itemType="text" :itemLabel="__('Code')"
                        :active="!editingMode" />
    ...
    methods: {
        ShowDialog() {
            ...
            if (this.accounting_item !== null) {
                this.form.code = this.accounting_item.code;
        ...
        submit() {
            axios
                .post(route("accounting.book.store"), this.form)
                .then((response) => {
