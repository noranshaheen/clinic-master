<template>
    <app-layout>
        ...
        <div class="lg:py-2">
            <p class="px-2 my-2 w-fit sm:px-6 lg:px-8">{{ __("Withdraw Items From Stock") }}</p>
            <div class="mx-auto sm:px-6 lg:px-8">
                <jet-validation-errors class="mb-4 sm:px-6 lg:px-8 text-xl" />
                <div class="bg-white shadow-xl sm:rounded-lg px-4 pb-4 pt-0">
                    <div class="grid lg:grid-cols-2 gap-4 sm:grid-cols-1 h-1/2">
                        ...
                        <div class="">
                            ...
                            <select v-model="form.clinic_id
                                " class="mt-1 w-full border-slate-300 rounded-md" @change="getWarehouses(form.clinic_id)">
                    ...
                    <div>
                        <div class="w-1/2">
                            <div class="result my-5 px-1 w-full">
                                <table class="w-full">
                                    <thead class="w-full text-center bg-gray-300">
                                        <th class="bg-[#f8f9fa] p-1 border border-[#eceeef] w-6/12">
                                            {{ __('Item') }}
...
export default {
    ...
    methods: {
        ...
        onSave: function () {
            axios
                .post(route("inventory.store.outs"), this.form)
                .then((response) => {
    ...
    created: function created() {
        ...
        axios
            ...
            .then((response) => {
                ...
                this.items = temp.filter((item) => item.storable == 1);
